package org.wchill.jsoup.select;

import org.wchill.jsoup.helper.Validate;
import org.wchill.jsoup.nodes.Comment;
import org.wchill.jsoup.nodes.Document;
import org.wchill.jsoup.nodes.DocumentType;
import org.wchill.jsoup.nodes.Element;
import org.wchill.jsoup.nodes.Node;
import org.wchill.jsoup.nodes.PseudoTextElement;
...
import static org.wchill.jsoup.internal.Normalizer.lowerCase;
import static org.wchill.jsoup.internal.Normalizer.normalize;
import static org.wchill.jsoup.internal.StringUtil.normaliseWhitespace;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<org.wchill.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (org.wchill.jsoup.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    org.wchill.jsoup.parser.Tag.valueOf(element.tagName(), element.tag().namespace(), ParseSettings.preserveCase), element.baseUri(), element.attributes());
