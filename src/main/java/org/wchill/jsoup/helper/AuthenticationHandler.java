...
/**
 Handles per request Authenticator-based authentication. Loads the class `org.wchill.jsoup.helper.RequestAuthHandler` if
...
class AuthenticationHandler extends Authenticator {
    ...
    static {
        try {
            ...
            Class<AuthShim> perRequestClass = (Class<AuthShim>) Class.forName("org.wchill.jsoup.helper.RequestAuthHandler");
