...
public class UrlConnectTest {
    ...
    public void exceptOnUnknownContentType() {
        ...
        try {
            ...
            threw = true;
            assertEquals("org.wchill.jsoup.UnsupportedMimeTypeException: Unhandled content type. Must be text/*, application/xml, or application/xhtml+xml. Mimetype=image/png, URL=http://direct.jsoup.org/rez/osi_logo.png", e.toString());
